...
def main(args):
    ...
    # List of results to load. These come from the QG Tagging Reference Dataset
    ...
    for network in results:
        ...
        if filename.endswith(".root"): ## weaver output
            ...
            if score.shape[-1] == 3 : # EGNN.py
                ...
                acc = ((score > 0.5) == labels).sum()/labels.shape[0]
    ...
    print(f"AUC Mean:{auca.mean():.5f}, std: {auca.std():.5f}")
